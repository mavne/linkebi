...
class favorites extends CI_Controller
{
	public function index()
	{
		...
		if($data["username"])
		{
			...
			// load user favourite websites
			$this->load->model("md_favourites");
			$data["favourites"] = $this->md_favourites->fav($this->session->userdata('username'));

			// load view page
			$this->load->view('favourite_message', $data);
		}
		else
		{
