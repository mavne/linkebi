...
<html lang="en" class="login_page">
    <head>
        ...
        <!-- Bootstrap framework -->
            <link rel="stylesheet" href="assets/ciadmin/bootstrap.min.css" />
        <!-- theme color-->
            <link rel="stylesheet" href="assets/ciadmin/blue.css" />
        <!-- tooltip -->    
			<link rel="stylesheet" href="assets/ciadmin/jquery.qtip.min.css" />
        <!-- main styles -->
            <link rel="stylesheet" href="assets/ciadmin/style.css" />
    
        <!-- favicon -->
            <link rel="shortcut icon" href="assets/ciadmin/favicon.ico" />
    ...
    <body>
        ...
        <script src="assets/ciadmin/jquery.min.js"></script>
        <script src="assets/ciadmin/jquery.actual.min.js"></script>
        <script src="assets/ciadmin/jquery.validate.js"></script>
		<script src="assets/ciadmin/bootstrap.min.js"></script>
        <script>
            $(document).ready(function(){
				...
				$('#login_form').validate({
					...
					highlight: function(element) {
						$(element).closest('div.form-group').addClass("f_error");
						setTimeout(function() {
							boxHeight()
						}, 200)
					},
					unhighlight: function(element) {
						$(element).closest('div.form-group').removeClass("f_error");
						setTimeout(function() {
							boxHeight()
						}, 200)
					},
